...
/**
 * Validates the JWT access token on every request and populates the SecurityContext.
 * Stateless — no session is created (see SecurityConfig, SessionCreationPolicy.STATELESS).
 */
@Component
